...
<div class="col-md-10">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<a href="index.html" class="btn btn-success"></span> 商品页面</a>
					...
					<div class="panel-body">
						<form action="/admin/goods" method="post">
							...
							<div class="form-group">
								...
								<input type="text" name="num" class="form-control" id="" placeholder="请输入商品库存">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<script id="editors" type="text/plain" name="config" style="width:100%;height:300px;"></script>
							</div>
